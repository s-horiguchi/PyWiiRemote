...
class WiiRemoteApp(object):
    def __init__(self):
        self.param = {"conf_name":"settings.cfg", # load from argv or not
                      ...
                      "maxA":0.5, "maxG":0.1, "maxO":math.pi,
        ...
        self.data = {"accel":[[], [], []], "gyro_speed":[[], [], []], 
                     ...
                     "raw_gyro":[], "acc_average":[0,0,0], "calib_acc":[0,0,0],
    ...
    def calib_acc(self, ):
        raw_input('Enter>')
        self.data["calib_acc"] = self.data["acc_average"]
        return
    ...
    def turning_angle(self, old_theta, rotate):
        ...
        #
        theta = min(self.param["maxO"], max(theta, -self.param["maxO"]))
        #
    ...
    def accel(self, data, frametime):
        ...
        if len(cutoff_acc) > 0:
            ...
            if len(self.data["accel"][0]) >= 2:
                ...
                self.data["acc_average"] = acc_average
